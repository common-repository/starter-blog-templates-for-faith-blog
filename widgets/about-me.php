...
class Stffb_Aboutme_Widget extends WP_Widget {

	function __construct() {
		parent::__construct(
			'aboutme_widget',
			esc_html__( '[ Faith Blog ] About Me', 'stffb' )
		);
	...
	public function widget( $args, $instance ) {
        ...
        ?>
            ...
            <div class="author-content">
                ...
                <?php if (true === $show_social_icon): ?>
                    <div class="about-social-link">
                        <?php stffb_social_activity(); ?>
                    </div>
                <?php endif; ?>
            </div>
        <?php
...
if (!function_exists('stffb_register_aboutme_widget')) {
	function stffb_register_aboutme_widget() {
		register_widget( 'Stffb_Aboutme_Widget' );
	}
}
